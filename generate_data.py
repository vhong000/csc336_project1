"""
generate_data file is used to randomly generate 100 game, member and requirement entries
which are used to populate our database. Each function creates a corresponding
comma separated file filled with 100 specified entries which are later inserted
into database as tuples.
"""
import string
import random
...
def generate_game_data():
    """function to generate 100 game entries and save them to game_data.csv"""
...
def generate_member_data():
    """function to generate 100 member entries and save them to member_data.csv"""
...
def generate_req_data():
    """function to generate 100 requirement entries and save them to req_data.csv"""
